...
要求：构思的故事方向、主角气质与叙述基调向这些风格靠拢。`;
  ...
  const GF_POOL = isFantasy
    ? ['系统面板/数值化', '血脉体质觉醒', '古老传承记忆', '器物法宝', '特殊技能天赋', '预知信息优势', '契约召唤', '规则因果操控', '商业资源整合', '战斗本能武学']
    : ['前世记忆/信息优势', '被埋没的天赋觉醒', '关键人脉关系网', '超强洞察力/共情', '商业直觉/创业天赋', '突出体能/竞技特长', '家传手艺/特殊技艺', '人格魅力/社交天赋', '逆境反弹韧性', '细节记忆/观察力'];
  const ID_POOL = isFantasy
    ? ['底层草根', '落魄贵族后人', '隐世传人', '现代上班族穿越', '市井游民', '少年天才', '军方武力背景', '商贾之后', '工匠手艺人', '戴罪之身']
    : ['刚毕业的大学生', '职场新人', '创业失败者', '转行新人', '校园学生', '退役运动员', '回乡的都市人', '单亲家长', '职场中年危机', '社恐青年'];
  const gfLabel = isFantasy ? '金手指类型' : '核心优势类型';
...
- 主角的"${gfLabel}"必须是现实中可能存在的个人优势（天赋/人脉/经验/洞察等），严禁出现系统面板、血脉觉醒、契约召唤、灵气修炼等超自然设定。
- 违反题材贴合的创意视为废稿。`;
